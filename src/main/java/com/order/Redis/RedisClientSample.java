...
/**
 * Jedis使用样例。没有在项目程序中使用过。
 *
 * Created by LiMingji on 15/7/10.
 */

public class RedisClientSample implements Serializable{
...
//        config.setMaxWait(1000l);
        ...
        shards.add(new JedisShardInfo("10.212.239.157", 6379, "master"));
